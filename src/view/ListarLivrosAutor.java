 ...
 * @author Alisson
 */
public class ListarLivrosAutor extends javax.swing.JFrame {
     ...
     */
    public ListarLivrosAutor(Menu calledBy) throws Exception {
        initComponents();
    ...
    private String getLivrosAutorList(Autor autor) {
        String text = "Autor - " + autor.toString() + "\n------------------------------\n";
